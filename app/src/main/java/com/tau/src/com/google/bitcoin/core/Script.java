...
import static com.mofei.tau.src.com.google.bitcoin.core.Utils.bytesToHexString;
...
public class Script {
    ...
    // For taucoin, checking reward script code is 0xc0
    public static final int OP_CHECKREWARDSIG = 192;
