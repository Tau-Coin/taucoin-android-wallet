...
public class RawTxBean {
    ...
    public static class VinBean {
        ...
        private String txid;
        private int vout;
        private VinBean.ScriptSigBean scriptSig;
        ...
        public VinBean.ScriptSigBean getScriptSig() {
            return scriptSig;
        }

        public void setScriptSig(VinBean.ScriptSigBean scriptSig) {
    ...
    public static class VoutBean {
        ...
        private int n;
        private VoutBean.ScriptPubKeyBean scriptPubKey;
        ...
        public VoutBean.ScriptPubKeyBean getScriptPubKey() {
            return scriptPubKey;
        }

        public void setScriptPubKey(VoutBean.ScriptPubKeyBean scriptPubKey) {
