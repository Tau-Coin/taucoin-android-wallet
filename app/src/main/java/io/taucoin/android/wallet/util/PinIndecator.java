...
public class PinIndecator  extends LinearLayout {
    @IntDef({IndicatorDots.IndicatorType.FIXED, IndicatorDots.IndicatorType.FILL, IndicatorDots.IndicatorType.FILL_WITH_ANIMATION})
    ...
    public PinIndecator(Context context) {
        this(context, null);
    }

    public PinIndecator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PinIndecator(Context context, AttributeSet attrs, int defStyleAttr) {
